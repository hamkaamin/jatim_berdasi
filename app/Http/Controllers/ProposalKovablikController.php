...
class ProposalKovablikController extends Controller
{
    ...
    public function save(Request $request)
    {
        $request->validate([
            ...
            'kategori_kovablik_id'               => ['required'],
            'kov_jenis_inovasi'                  => ['required'],
            'tanggal_mulai'                      => ['required', 'date'],
            'nama_inovator'                      => ['required'],
            'kov_nip_inovator'                   => ['required'],
            'kov_link_video'                     => ['required'],
            'kov_keterangan_video'               => ['required'],
            'kov_sektor_pemerintahan_id'         => ['required'],
            'kov_koordinat'                      => ['required'],
            ...
            'nama.required'                       => 'Judul Inovasi harus diisi',
            'kelompok_id.required'                => 'Kelompok Inovasi harus dipilih',
            'kategori_kovablik_id.required'       => 'Kategori harus dipilih',
            'kov_jenis_inovasi.required'          => 'Jenis Inovasi harus dipilih',
            'tanggal_mulai.required'              => 'Waktu Mulai Implementasi harus diisi',
            'tanggal_mulai.date'                  => 'Waktu Mulai Implementasi harus berupa tanggal yang valid',
            'nama_inovator.required'              => 'Nama Inovator harus diisi',
            'kov_nip_inovator.required'           => 'NIP Inovator harus diisi',
            'kov_link_video.required'             => 'Link Video harus diisi',
            'kov_keterangan_video.required'       => 'Keterangan Video harus diisi',
            'kov_sektor_pemerintahan_id.required' => 'Sektor Pemerintahan harus dipilih',
            'kov_koordinat.required'              => 'Koordinat harus diisi',
