...
@section('title')
    Master Kategori Inovasi
@endsection

@section('title-desc')
    Daftar Kategori untuk Data Inovasi
@endsection

@section('buttons')
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalPopup"
        onclick="modal(0, 'kategori')">Tambah Data</button>
@endsection
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form style="all: unset"
                                        action="{{ route('master.kategori.delete', ['id' => $item->id]) }}" method="post">
                                        @csrf
