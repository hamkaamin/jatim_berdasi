    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="d-none d-lg-flex align-items-center ms-1">
                &nbsp;
                &nbsp;
                <a href="javascript:;" data-toggle="modal" data-target="#modalPopup" onclick="modal(0,'setting')">
                    <span class="badge bg-primary badge-sm text-light">
            ...
            <form action="{{ route('logout') }}" method="post" class="dropdown d-none d-lg-inline-block ms-1">
                @csrf
