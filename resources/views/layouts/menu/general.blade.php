    ...
    @else
        ...
        <div style="display: none">
            @if (Auth::user()->role == 2 || Auth::user()->role == 3)
                <li class="app-sidebar__heading"><i class="afu metismenu-icon pe-7s-user"></i> Database Inovasi Daerah
                </li>
                <li>
        ...
        <li class="app-sidebar__heading"><i class="afu metismenu-icon pe-7s-light"></i> Data Inovasi Daerah</li>
        ...
        @if (env('APP_PROVINSI_JATIM') == 0)
            @if (env('APP_OPD_JATIM') == 1)
                <li class="app-sidebar__heading"><i class="afu metismenu-icon pe-7s-light"></i> Lomba Inovasi</li>
            @else
                <li class="app-sidebar__heading"><i class="afu metismenu-icon pe-7s-light"></i> Lomba Inovasi Daerah
                </li>
            @endif
            @if (Auth::user()->role != 6)
                {{-- <li>
        ...
        @if (Auth::user()->role == 7)
            <li class="app-sidebar__heading"><i class="afu metismenu-icon pe-7s-light"></i> Penilaian Juri</li>
        ...
        @if (Auth::user()->role_id == 1 || Auth::user()->role_id == 3)
            <li class="app-sidebar__heading"><i class="afu metismenu-icon pe-7s-users"></i> Konfigurasi</li>
            <li>
