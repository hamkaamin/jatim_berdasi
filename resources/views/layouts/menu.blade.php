<ul class="vertical-nav-menu">
	@if (Auth::user()->role == 1)
		...
		<li>
			<a href="{{ route('master.indikator.index') }}" class="{{ Request::routeIs('master.indikator.*') ? 'mm-active' : '' }}">
				<i class="metismenu-icon pe-7s-ribbon"></i> Indikator & Parameter
			</a>
		</li>
		<li>
			<a href="{{ route('master.tahapan.index') }}" class="{{ Request::routeIs('master.tahapan.*') ? 'mm-active' : '' }}">
				<i class="metismenu-icon pe-7s-ribbon"></i> Tahapan Inovasi
			</a>
		</li>
		<li>
			<a href="{{ route('master.inisiator.index') }}" class="{{ Request::routeIs('master.inisiator.*') ? 'mm-active' : '' }}">
				<i class="metismenu-icon pe-7s-ribbon"></i> Inisiator Inovasi
			</a>
		</li>
		<li>
			<a href="{{ route('master.jenis.index') }}" class="{{ Request::routeIs('master.jenis.*') ? 'mm-active' : '' }}">
				<i class="metismenu-icon pe-7s-ribbon"></i> Jenis Inovasi
			</a>
		</li>
		<li>
			<a href="{{ route('master.urusan.index') }}" class="{{ Request::routeIs('master.urusan.*') ? 'mm-active' : '' }}">
				<i class="metismenu-icon pe-7s-ribbon"></i> Urusan Inovasi
			</a>
		</li>
		<li>
			<a href="{{ route('master.bentuk.index') }}" class="{{ Request::routeIs('master.bentuk.*') ? 'mm-active' : '' }}">
				<i class="metismenu-icon pe-7s-ribbon"></i> Bentuk Inovasi
			</a>
		</li>
		<li>
			<a href="{{ route('master.jabatan.index') }}" class="{{ Request::routeIs('master.jabatan.*') ? 'mm-active' : '' }}">
				<i class="metismenu-icon pe-7s-ribbon"></i> Jabatan Inovasi
			</a>
		</li>
		<li>
			<a href="{{ route('master.golongan.index') }}" class="{{ Request::routeIs('master.golongan.*') ? 'mm-active' : '' }}">
				<i class="metismenu-icon pe-7s-ribbon"></i> Golongan Inovasi
			</a>
		</li>
		<li>
			<a href="{{ route('master.faq.index') }}" class="{{ Request::routeIs('master.faq.*') ? 'mm-active' : '' }}">
