                ...
                <div class="container d-flex align-items-center justify-content-lg-between position-relative">
                    ...
                    <div class="collapse navbar-collapse justify-content-center">
                        <ul class="nav col-12 col-md-auto justify-content-center main-menu">
                            ...
                            <li><a href="https://indeks.inovasi.litbang.kemendagri.go.id/pengumuman" target="_blank"
                                    class="nav-link">Pengumuman</a></li>
                            <li><a href="https://indeks.inovasi.litbang.kemendagri.go.id/panduan" target="_blank"
                                    class="nav-link">Manual Book</a></li>
                            <li><a href="https://indeks.inovasi.litbang.kemendagri.go.id/dokumen" target="_blank"
                                    class="nav-link">Petunjuk Teknis</a></li>
                        </ul>
                    </div>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasWithBackdrop">
                <div class="offcanvas-header d-flex align-items-center mt-4">
                    <a href="{{ url('/') }}" class="d-flex align-items-center mb-md-0 text-decoration-none">
                        <img src="{{ asset('assets_landing/img/logo-color.png') }}" alt="logo"
                            ...
                            <div class="dropdown-menu border-0 rounded-custom shadow py-0 bg-white">
                                <div class="dropdown-grid rounded-custom width-full-3">
                                    ...
                                    <div class="dropdown-grid-item last-item bg-light radius-right-side">
                                        <a href="#"><img
                                                src="{{ asset('assets_landing/img/feature-img3.jpg') }}"
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-md-7 col-lg-7">
                            <div class="copyright-text">
                                <p class="mb-lg-0 mb-md-0"> Badan Penelitian dan Pengembangan Provinsi Jawa Timur -
                                    &copy; Copyright 2022. All Rights Reserved. Developed By <a
                                        href="https://kodig.id/" target="_blank"
                                        class="text-decoration-none">Kodig.id</a></p>
                            </div>
                        </div>
