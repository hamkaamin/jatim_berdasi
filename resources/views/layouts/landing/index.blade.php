...
<head>
    ...
    <!--meta-->
    <meta name="description" content="SATUPETA KOTA SURABAYA">
    <meta name="author" content="MHR">
...
<body>
    ...
    <div id="preloader">
        <div class="preloader-wrap">
            <img src="{{asset('assets_landing/img/favicon.png')}}" alt="logo" class="img-fluid preloader-icon" />
            ...
            <nav class="navbar navbar-expand-xl navbar-dark sticky-header z-10">
                <div class="container d-flex align-items-center justify-content-lg-between position-relative">
                    <a href="{{ url('/') }}" class="navbar-brand d-flex align-items-center mb-md-0 text-decoration-none">
                        <span class="img-fluid logo-white logo_txt" >{{ env('APP_NAME') }}</span>
                        <span class="img-fluid logo-color logo_txt" style="color: black" >{{ env('APP_NAME') }}</span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-center">
                        <ul class="nav col-12 col-md-auto justify-content-center main-menu">
                            ...
                            <li><a href="https://indeks.inovasi.litbang.kemendagri.go.id/pengumuman" target="_blank" class="nav-link">Pengumuman</a></li>
                            <li><a href="https://indeks.inovasi.litbang.kemendagri.go.id/panduan" target="_blank" class="nav-link">Manual Book</a></li>
                            <li><a href="https://indeks.inovasi.litbang.kemendagri.go.id/dokumen" target="_blank" class="nav-link">Petunjuk Teknis</a></li> 
                        </ul>
                    </div>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasWithBackdrop">
                <div class="offcanvas-header d-flex align-items-center mt-4">
                    <a href="{{ url('/') }}" class="d-flex align-items-center mb-md-0 text-decoration-none">
                        <img src="{{asset('assets_landing/img/logo-color.png')}}" alt="logo" class="img-fluid ps-2" />
                    </a>
                            ...
                            <div class="dropdown-menu border-0 rounded-custom shadow py-0 bg-white">
                                <div class="dropdown-grid rounded-custom width-full-3">
                                    ...
                                    <div class="dropdown-grid-item last-item bg-light radius-right-side">
                                        <a href="#"><img src="{{asset('assets_landing/img/feature-img3.jpg')}}" alt="add" class="img-fluid rounded-custom" /></a>
                                    </div>
                                </div>
                            </div>
                        </li>
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-md-7 col-lg-7">
                            <div class="copyright-text">
                                <p class="mb-lg-0 mb-md-0"> Badan Penelitian dan Pengembangan Provinsi Jawa Timur - &copy; Copyright 2022. All Rights Reserved. Developed By <a href="https://kodig.id/" target="_blank" class="text-decoration-none">Kodig.id</a></p>
                            </div>
                        </div>
    ...
    <!--build:js-->
    <script src="{{asset('assets_landing/js/vendors/jquery-3.6.0.min.js')}}"></script>
    <script src="{{asset('assets_landing/js/vendors/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets_landing/js/vendors/swiper-bundle.min.js')}}"></script>
    <script src="{{asset('assets_landing/js/vendors/jquery.magnific-popup.min.js')}}"></script>
    <script src="{{asset('assets_landing/js/vendors/parallax.min.js')}}"></script>
    <script src="{{asset('assets_landing/js/vendors/aos.js')}}"></script>
