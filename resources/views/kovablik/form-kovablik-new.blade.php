...
@endif
            ...
            <div class="row">
                <label>Link File</label>
                <input type="text" value="" placeholder="Contoh : https://drive.google.com/drive/1231823912109ajskdjh1i2" class="form-control mt-2" name="file_sumber_daya" accept=".jpg,.jpeg,.png,.pdf">
            </div>
        </div>
    </div>
