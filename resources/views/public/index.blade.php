...
@section('konten_front')
    <section class="hero-section ptb-120 text-white bg-gradient" style="background: url('{{asset('assets_landing/img/hero-dot-bg.png')}}')no-repeat center right">
        <div class="container">
                    ...
                    <div class="hero-img position-relative circle-shape-images">
                        ...
                        <ul class="position-absolute animate-element parallax-element circle-shape-list">
                            <li class="layer" data-depth="0.03">
                                <img src="{{asset('assets_landing/img/shape/circle-1.svg')}}" alt="shape" class="circle-shape-item type-0 hero-1">
                            </li>
                            <li class="layer" data-depth="0.02">
                                <img src="{{asset('assets_landing/img/shape/circle-1.svg')}}" alt="shape" class="circle-shape-item type-1 hero-1">
                            </li>
                            <li class="layer" data-depth="0.04">
                                <img src="{{asset('assets_landing/img/shape/circle-1.svg')}}" alt="shape" class="circle-shape-item type-2 hero-1">
                            </li>
                            <li class="layer" data-depth="0.04">
                                <img src="{{asset('assets_landing/img/shape/circle-1.svg')}}" alt="shape" class="circle-shape-item type-3 hero-1">
                            </li>
                            <li class="layer" data-depth="0.03">
                                <img src="{{asset('assets_landing/img/shape/circle-1.svg')}}" alt="shape" class="circle-shape-item type-4 hero-1">
                            </li>
                            <li class="layer" data-depth="0.03">
                                <img src="{{asset('assets_landing/img/shape/circle-1.svg')}}" alt="shape" class="circle-shape-item type-5 hero-1">
                            </li>
                        </ul>
                        <!--animated shape end-->
                        <img src="{{asset('assets_landing/img/hero-1.png')}}" alt="hero img" class="img-fluid position-relative z-5">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="position-relative single-pricing-wrap rounded-custom bg-white custom-shadow p-5 mb-4 mb-lg-0">
                        ...
                        <center>
                            <img src="{{asset('login.png')}}" height="50%" width="50%" style="text-align: center">
                        </center>
