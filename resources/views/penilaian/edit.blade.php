...
@section('content')
    @if (env('APP_CLOSE_APP') == 0)
        ...
        <form action="{{ route('penilaian.save', ['inovasi_id' => $inovasi->id, 'penilaian_map' => optional($penilaian_map)->id]) }}"
            ...
            <div class="split-container" data-storage-key="penilaian-inovasi">
